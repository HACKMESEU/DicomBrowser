...
from dwilib.dwi.fit import Parameter, Model
import dwilib.dwi.util
...
ParamC = Parameter('C', (1, 1, 1), (0, 2000))
...
Models.append(Model(
    ...
    None,
    [],
    preproc=dwilib.dwi.util.normalize_si_curve))
...
Models.append(Model(
    ...
    lambda p, x: adcm(x, *p),
    [
        Parameter('ADCm', (0.0001, 0.003, 0.00002), (0, 1)),
        ParamC
    ]))
Models.append(Model(
    'MonoN',
    ...
    lambda p, x: adcm(x, *p),
    [
        Parameter('ADCmN', (0.0001, 0.003, 0.003), (0, 1)),
    ],
    preproc=dwilib.dwi.util.normalize_si_curve))
...
Models.append(Model(
    ...
    lambda p, x: adck(x, *p),
    [
        Parameter('ADCk', (0.0001, 0.003, 0.001), (0, 1)),
...
Models.append(Model(
    ...
    lambda p, x: adcs(x, *p),
    [
        Parameter('ADCs', (0.0001, 0.003, 0.0001), (0, 1)),
...
Models.append(Model(
    ...
    lambda p, x: adcs(x, *p),
    [
        Parameter('ADCsN', (0.0001, 0.003, 0.0015), (0, 1)),
        Parameter('AlphaN', (0.5, 1.0,0.5), (0, 1)),
    ],
    preproc=dwilib.dwi.util.normalize_si_curve))
